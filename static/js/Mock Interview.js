...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Auto-start camera on session page
    if (cameraFeed) {
        startCamera();
    }
    ...
    // Stop camera explicitly if back button clicked
    ...
    // ========================
    // 5. Speech-to-Text (STT) per question
    // ========================
    ...
    // Attach live word count to all qa textareas
